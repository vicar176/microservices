...
public class MediaDocument extends BaseDomain {
	...
	private String mediaMetadataModelId;
	...
	public String getMediaMetadataModelId() {
		return mediaMetadataModelId;
	}

	public void setMediaMetadataModelId(String mediaMetadataModelId) {
		this.mediaMetadataModelId = mediaMetadataModelId;
	}
